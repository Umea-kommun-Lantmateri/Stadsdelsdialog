    ...
    init: function () {
        ...
        for (var i = 0; i < buttons.length; i++) {
            buttons[i].addEventListener("click", function () {
                network.GET(RootPath + "api/HidePost/" + this.getAttribute("data-id"), function (data) {
        ...
        var Stats_kategori = document.querySelectorAll(".Stats_kategori");
